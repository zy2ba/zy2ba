...
%-----       resume       ---------------------------------------------------------
   ...
   \section{Участие в проектах}\label{sec:projects}
      ...
      \subsection{Gymbo}\label{subsec:gymbo}
         ...
         \cvlistitem{В сентябре 2020 проект потерял проджект менеджера, потому пришлось временно брать на себя его обязанности, пока не нашли нового человека, а так же впоследствии передавать ему дела вводя в курс дела}
